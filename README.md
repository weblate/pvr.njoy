...
[![Build Status](https://ci.appveyor.com/api/projects/status/github/kodi-pvr/pvr.njoy?branch=Matrix&svg=true)](https://ci.appveyor.com/project/kodi-pvr/pvr-njoy?branch=Matrix)
